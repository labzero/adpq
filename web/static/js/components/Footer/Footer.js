      ...
      <div className="usa-grid-full">
        <div className="usa-footer-nav">
          <ul className="usa-unstyled-list">
            <li className="usa-width-one-fourth">
            ...
            <li className="usa-width-one-fourth">
              <a className="usa-footer-primary-link" href="/category/Brands">Brands</a>
            </li>
            <li className="usa-width-one-fourth">
              <a className="usa-footer-primary-link" href="/category/Publishers">Publishers</a>
            </li>
          </ul>
        </div>
      </div>
