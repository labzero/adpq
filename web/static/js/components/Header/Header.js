...
class Header extends Component {
  ...
  render() {
    ...
    let navPrimary = '';
    if (this.props.navigationMode === 'admin') {
      navPrimary = (
        <ul className="nav-primary usa-nav-primary">
          <li>
    ...
    } else if (this.props.navigationMode === 'default') {
      navPrimary = (
    ...
    let rootLink;
    if (this.props.navigationMode === 'admin') {
      rootLink = (<a href="/admin" accessKey="1" title="Admin" aria-label="Home">Tech Shop Admin</a>);
    } else {
      rootLink = (<a href="/" accessKey="1" title="Home" aria-label="Home">Tech Shop</a>);
    }
