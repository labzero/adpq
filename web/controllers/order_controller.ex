defmodule Adpq.OrderController do
  ...
  alias Adpq.{Order, OrderItem, User}
  ...
  def create(conn, %{"user_id" => user_id}) do
    ...
    case user.cart_items do
      [] ->
        ...
        |> render(Adpq.ErrorView, "error.json", %{message: "Empty Cart"})
      _ ->
        # create order
        order = Repo.insert!(Order.changeset(%Order{}, %{user_id: user_id, status: Order.Status.submitted}))
