defmodule Adpq.OrderQueries do
  ...
  def with_order_items(query) do
    ...
    |> preload([users, orders, order_items, catalog_items], [orders: {orders, order_items: {order_items, catalog_item: catalog_items}}])
  end
  ...
  def with_cart_items(query) do
    ...
    |> preload([users, cart_items, catalog_items], [cart_items: {cart_items, catalog_item: catalog_items}])
  end
