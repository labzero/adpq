defmodule AdpqWeb.CatalogItemView do
  use Adpq.Web, :view

  alias AdpqWeb.{CatalogItemView, ViewHelpers}

  def render("index.json", %{catalog_items: catalog_items}) do
    render_many(catalog_items, CatalogItemView, "catalog_item.json")
  end

  def render("show.json", %{catalog_item: catalog_item}) do
    render_one(catalog_item, CatalogItemView, "catalog_item.json")
  end
