defmodule AdpqWeb.Admin.CatalogItemController do
  ...
  def index(conn, _params) do
    ...
    render(conn, CatalogItemView, "index.json", catalog_items: catalog_items)
  end
  ...
  def show(conn, %{"id" => id}) do
    ...
    render(conn, CatalogItemView, "show.json", catalog_item: catalog_item)
  end
  ...
  def create(conn, params) do
    ...
    case Repo.insert(changeset) do
      {:ok, item} ->
        ...
        |> render(CatalogItemView, "show.json", catalog_item: item)
      {:error, changeset} ->
        conn
